...
This statement will ensure that you can further use this contant EventEmitter to call the methods available under Node.js> Events Documentation (the EventEmitter class is already present under this).
