...
Using var will throw an error that is difficult to as to be arising from overwriting. However, using const throws an error which tells that it has be Assigned again.
